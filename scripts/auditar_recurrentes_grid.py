...
from recurrentes_grid_core import grid,predict,FAMILY
from entrenar_recurrentes_grid import OUT
...
def main():
    ...
    assert external=={(f['fold'],s,seed) for f in protocol['folds'] for s in [FAMILY,'repeat_current'] for seed in protocol['seeds']}
